...
const pages = {
  ...
  eenheden: {
    ...
    en: {
      ...
      faq: [
        {
          q: "How many mm is 1 inch?",
          a: "Exactly 25.4 mm. That is the international inch since 1959 (ISO 1). 1 ft = 12 in = 304.8 mm.",
        },
        {
          q: "Is 1 dm³ the same as 1 L?",
          a: "Yes. The litre is defined as 1 dm³, so 0.001 m³. 1 mL = 1 cm³.",
        },
        {
          q: "Celsius to kelvin?",
          a: "T/K = t/°C + 273.15. 0 °C = 273.15 K; 20 °C = 293.15 K. Fahrenheit: T/K = (t/°F + 459.67) × 5/9.",
        ...
        {
          q: "pk or hp?",
          a: "pk is metric horsepower (735.49875 W). hp is mechanical horsepower (745.69987 W). For IEC motor steps use kW, not pk.",
        },
        {
          q: "US gallon or UK gallon?",
          a: "US liquid gallon = 231 in³ = 3.785411784 L. Imperial (UK) gallon = 4.54609 L. They are not interchangeable.",
        },
      ],
    },
  },
    ...
    en: {
      ...
      faq: [
        ...
        },
        {
          ...
          a: "Clearance fit: hole H7, shaft g6. Always clearance. Typical for sliding or accurately movable parts.",
        },
        {
          q: "Why are 30–40 mm and 40–50 mm separate?",
          a: "IT grades are the same for 30–50 mm (H7 = 25 µm). The fundamental deviation of c changes at 40 mm, so H11/c11 has two rows.",
        },
        {
        ...
        },
        {
          ...
          a: "Tables and calculator are in mm, converted from ISO 286 (µm). JS7 shows four decimals where IT7 is odd.",
        },
      ],
    },
  },
  cilinder: {
    nl: {
      ...
      faq: [
        ...
        },
        {
          ...
          a: "Nee. Alleen de ISO-boring en basisstang. Geen typecode, geen demping, geen sensorsleuf.",
        },
        {
    ...
    en: {
      ...
      faq: [
        {
          q: "What is F = p·A?",
          a: "Theoretical force: gauge pressure (N/mm²) times piston area. 1 bar = 0.1 N/mm². No friction, no seal loss.",
        },
        {
          q: "6 bar or 6 bar absolute?",
        ...
        },
        {
          ...
          a: "No. ISO bore and basic rod only. No type code, no cushioning, no sensor slot.",
        },
        {
    ...
    en: {
      ...
      faq: [
        ...
        },
        {
          ...
          a: "Below 0.5 mm the standard has no row. The deviation then sits next to the nominal size. Same if a table cell is empty (—).",
        },
        {
          q: "Is this a fit?",
          a: "No. Fits (H7/g6, clearance, interference) are ISO 286. ISO 2768 is the default when there is no box around the dimension.",
        },
        {
  ...
  spiebaan: {
    ...
    en: {
      ...
      faq: [
        {
          q: "What are t1 and t2 in DIN 6885?",
          a: "t₁ is groove depth in the shaft, t₂ in the hub. b × h is the key size.",
        },
        {
          q: "Which width tolerance is standard?",
          a: "P9 in shaft and hub: tight fit (DIN 6885-1:2021). Easy fit is N9 (shaft) / JS9 (hub). H9/D10 is a shop/UNI convention.",
        },
        {
          q: "Does Ø 6 mm belong in the table?",
          a: "No. DIN 6885-1: first row is above 6 mm through 8 mm. Exactly Ø 6 mm is outside.",
        },
        {
          q: "Difference between DIN 6885-1 and 6885-2?",
          a: "DIN 6885-1 is the high type. DIN 6885-2 is the low type, with a different radial key position.",
        },
      ],
    },
  },
  lager: {
    ...
    en: {
      ...
      faq: [
        {
          q: "When a tight fit on the shaft?",
          a: "When the inner ring rotates relative to the radial load. That ring tight, the other loose.",
        },
        {
          q: "Which shaft tolerance at deep-groove Ø 20 mm?",
          a: "Light: j6. Normal to heavy: k5. Housing usually H7, or K7 if the outer ring need not slide. js5 only through 17 mm.",
        },
  ...
  seeger: {
    ...
    en: {
      ...
      faq: [
        {
          q: "Difference between DIN 471 and DIN 472?",
          a: "DIN 471 is the circlip for a shaft: groove on the outside, d₂ smaller than d₁. DIN 472 is for a bore: groove on the inside, d₂ larger than d₁.",
        },
        {
          q: "How does t follow from the table?",
          a: "t is nominal groove depth: |d₁ − d₂| / 2. At Ø 20 mm shaft, d₂ = 19 mm, so t = 0.5 mm.",
        },
        {
          q: "Is there a tolerance on groove depth?",
          a: "DIN gives t as a calculated size at nominal d₁/d₂. The dimensional tolerance is on d₂: h11 on the shaft, H11 in the bore. t therefore becomes 0 / +IT11/2 (Ø 20 shaft: 0 / +0.065 mm). Deeper is allowed, shallower is not — otherwise the ring dishes. Width b is H13.",
        },
        {
          q: "Why is Ø 23 mm missing?",
          a: "Circlips are nominal sizes, not ranges like keyways. Only the rows in DIN 471/472 (and this shop table to 100 mm) exist.",
        },
        {
          q: "Where does the table come from?",
          a: "Shop table for circlip grooves, among others verspanen-metaal, matching DIN 471/472. n-min. (distance to the shoulder) is not in that table — take it from the standard if the load requires it.",
        },
      ],
    },
  },
  bevestigers: {
    ...
    en: {
      ...
      faq: [
        {
          q: "Which clearance hole is standard?",
          a: "Medium (ISO 273 medium). Fine for accurate alignment, coarse for sheet or rough holes.",
        },
        {
          q: "Tightening torque M8 8.8?",
          a: "27.3 N·m at μ = 0.14, dry, 90 % Rp0.2 (VDI 2230-1 A1). Preload 18 100 N. Lubricated μ is lower — torque down.",
        },
        {
          q: "Hex or socket?",
          a: "SW and k are ISO 4014/4017 (hex). s and dk are ISO 4762 (socket head). Same M thread, different head.",
        },
        {
          q: "Is this a VDI joint?",
          a: "No. Table A1 is a starting value for static, concentric load. Alternating load, clamp ratio and grip length you calculate in VDI 2230.",
        },
      ],
    },
  },
  oring: {
    ...
    en: {
      ...
      faq: [
        {
          q: "What is d₂?",
          a: "Cord diameter per ISO 3601-1. Five groups: 1.80 / 2.65 / 3.55 / 5.30 / 7.00 mm.",
        },
        {
          q: "Groove for 2.65 mm radial static?",
          a: "t = 2.0 mm (+0.05), b = 3.6 mm (+0.25). Nominal squeeze about 25 % — not a plus-minus tolerance.",
        },
      ],
    },
  },
  motor: {
    nl: {
      ...
      faq: [
        ...
        {
          q: "Kiest deze tool een motortype?",
          a: "Nee. Deze rekenhulp bepaalt alleen het bedrijfspunt: n, F, T en P. Geen typecode, geen voorraadkeuze.",
        },
        {
          q: "Wat is i ≈ 1450 / n?",
    ...
    en: {
      ...
      faq: [
        {
          q: "What is in P_motor?",
          a: "P_motor = P_shaft / η × f_b. η is drivetrain efficiency (default 0.85), f_b the service factor (default 1.2). P_shaft is F·v at the roller, in watts.",
        },
        {
          q: "What is the IEC step?",
          a: "The next catalogue value from the IEC 60034 kW series, not the calculated shaft power. 0.104 kW becomes 0.12 kW. Above 315 kW there is no step in this series.",
        },
        {
          q: "Does this pick a motor type?",
          a: "No. This calculator only finds the operating point: n, F, T and P. No type code, no stock pick.",
        },
        {
          q: "What is i ≈ 1450 / n?",
          a: "A family indication for a 4-pole motor at 50 Hz (synchronous 1500, full load around 1450 min⁻¹). Not a measured speed.",
        },
      ],
    },
  },
  kanten: {
    nl: {
      ...
      faq: [
        ...
        },
        {
          ...
          a: "Ri is de inwendige radius na kanten. w is groefwijdte van de matrijs, s de minimale beenlengte (opleg op de matrijs), x de Z-maat voor een Z-buiging. Lege cel betekent: niet in hun tabel.",
        },
        {
    ...
    en: {
      ...
      faq: [
        {
          q: "Is this ISO or DIN?",
          a: "No. It is 247TailorSteel Sophia’s intake spec. Other shops have other radii and leg lengths. Open their page; this is a worksheet.",
        },
        {
          q: "What are Ri, w, s and x?",
          a: "Ri is the inside radius after bending. w is die groove width, s the minimum leg length (overlay on the die), x the Z dimension for a Z-bend. Empty cell: not in their table.",
        },
        {
          q: "Why is alu 0.8 mm Ri empty?",
          a: "The 247 page has a dash there. That is not a neighbour of steel 0.8 or alu 1.0 mm. Do not fill a neighbouring value.",
        },
        {
          q: "Why the 10 and 12 mm note?",
          a: "247 notes those thicknesses cannot run the full sheet length. The tool still shows the row, with that caveat. Check the current page.",
        },
      ],
    },
  },
  knik: {
    nl: {
      ...
      faq: [
        {
          q: "Wat is F_cr?",
          a: "De kritieke Euler-last: F_cr = π² E I / L_eff². Boven deze last knikt de staaf elastisch, ongeacht de sterkte van het materiaal.",
        },
        {
          q: "Wat is L_eff?",
          a: "De knik-lengte L_eff = k · L. k volgt uit de inklemming: scharnier-scharnier k=1, ingeklemd-vrij k=2, ingeklemd-ingeklemd k=0,5, ingeklemd-scharnier k≈0,699.",
        },
        {
          q: "Waarom een waarschuwing bij lage λ?",
          a: "Euler geldt voor slanke staven. Bij lage slankheid (vuistregel λ < 100) overschat de formule de werkelijke sterkte; gebruik dan Tetmajer of de Johnson-parabool.",
        },
        {
          q: "Is dit een vervanging van EN 1993-1-1?",
          a: "Nee. Dit is de ideale Euler-theorie: geen initiële kromming, geen partiële veiligheidsfactoren. Voor kritieke constructies de norm of een FEM-check gebruiken.",
        },
      ],
    },
    en: {
      ...
      faq: [
        {
          q: "What is F_cr?",
          a: "The critical Euler load: F_cr = π² E I / L_eff². Above this load the strut buckles elastically, regardless of material strength.",
        },
        {
          q: "What is L_eff?",
          a: "The buckling length L_eff = k · L. k follows from the end condition: pinned-pinned k=1, fixed-free k=2, fixed-fixed k=0.5, fixed-pinned k≈0.699.",
        },
        {
          q: "Why a warning at low λ?",
          a: "Euler applies to slender struts. At low slenderness (rule of thumb λ < 100) the formula overestimates real strength; use Tetmajer or the Johnson parabola instead.",
        },
        {
          q: "Does this replace EN 1993-1-1?",
          a: "No. This is ideal Euler theory: no initial curvature, no partial safety factors. For critical structures, use the standard or an FEM check.",
        },
      ],
    },
  },
  doorbuiging: {
    nl: {
      ...
      faq: [
        {
          q: "Waar wordt afstand a vandaan gemeten?",
          a: "Bij vrij opgelegd vanaf het linker steunpunt. Bij uitkraging vanaf de inklemming. a moet tussen 0 en L liggen.",
        },
        {
          q: "Waarom staat er ook een maximum naast δ bij de last?",
          a: "Bij een last buiten het midden ligt de grootste doorbuiging niet onder de last zelf, maar iets verderop in het langste deel van de overspanning.",
        },
        {
          q: "Waarom maar twee inklemgevallen?",
          a: "Scharnier-scharnier en ingeklemd-vrij zijn statisch bepaald: directe formules. Ingeklemd-ingeklemd en ingeklemd-scharnier zijn statisch onbepaald en zitten (nog) niet in deze rekenhulp.",
        },
        {
          q: "Is dit een vervanging van EN 1993-1-1?",
          a: "Nee. Lineair-elastische balktheorie, kleine doorbuigingen, geen partiële veiligheidsfactoren. Voor kritieke constructies de norm of een FEM-check gebruiken.",
        },
      ],
    },
    en: {
      ...
      faq: [
        {
          q: "Where is distance a measured from?",
          a: "For simply supported, from the left support. For cantilever, from the fixed end. a must be between 0 and L.",
        },
        {
          q: "Why show a maximum next to δ at the load?",
          a: "For an off-center load, the largest deflection isn't under the load itself, but a bit further along the longer part of the span.",
        },
        {
          q: "Why only two end conditions?",
          a: "Pinned-pinned and fixed-free are statically determinate: direct formulas. Fixed-fixed and fixed-pinned are statically indeterminate and aren't (yet) in this calculator.",
        },
        {
          q: "Does this replace EN 1993-1-1?",
          a: "No. Linear-elastic beam theory, small deflections, no partial safety factors. For critical structures, use the standard or an FEM check.",
        },
      ],
    },
  },
      ...
      faq: [
        {
          ...
          a: "Dat is het standaard tekstformaat voor een VBA-module. Open de VBA-editor, voeg een module toe en plak de code, of importeer het .bas-bestand direct.",
        },
        {
          q: "Werkt dit ook in oudere versies?",
          a: "Geschreven voor 2024, maar de gebruikte API's zijn al jaren stabiel. Waarschijnlijk werkt het ook in 2021–2023; niet getest.",
        },
        {
          q: "Zijn dit productie-macro's?",
          a: "Nee. Basis-hulpmiddelen zonder foutafhandeling voor edge cases. Test eerst op een kopie, niet op een kritiek bestand.",
        },
        {
          q: "Moet ik macro's inschakelen?",
          a: "Ja, via het Trust Center (SolidWorks) of de macro-instellingen (Inventor). Macro's uit onbekende bron staan standaard uit.",
        },
      ],
    },
    en: {
      ...
      faq: [
        {
          q: "Why .bas files?",
          a: "That's the standard text format for a VBA module. Open the VBA editor, add a module and paste the code, or import the .bas file directly.",
        },
        {
          q: "Does this work in older versions?",
          a: "Written for 2024, but the APIs used have been stable for years. Likely works in 2021–2023 too; not tested.",
        },
        {
          q: "Are these production macros?",
          a: "No. Basic utilities with no edge-case error handling. Test on a copy first, not on a critical file.",
        },
        {
          q: "Do I need to enable macros?",
          a: "Yes, via the Trust Center (SolidWorks) or macro settings (Inventor). Macros from an unknown source are disabled by default.",
        },
      ],
    },
  },
