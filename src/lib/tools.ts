...
export const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    section: "calculators",
    slug: "bearing-life",
    title: { nl: "Lagerlevensduur (L10 / L10h)", en: "Bearing life (L10 / L10h)" },
    standard: "ISO 281",
    blurb: {
      nl: "Basis-levensduur L10/L10h, betrouwbaarheidsfactor a1 en statische veiligheid S0 = C0/P0.",
      en: "Basic rating life L10/L10h, reliability factor a1, and static safety S0 = C0/P0.",
    },
    tags: [
      "lager",
      "levensduur",
  ...
  },
  {
    ...
    standard: "Puntlast · UDL",
    blurb: {
      nl: "Doorbuiging van een balk onder een puntlast of gelijkmatig verdeelde last: vrij opgelegd of uitkraging.",
      en: "Deflection of a beam under a point load or uniformly distributed load: simply supported or cantilever.",
    },
    tags: [
      "puntlast",
      "buiging",
  ...
  },
  {
    ...
    section: "calculators",
    slug: "shaft-diameter",
    title: { nl: "Asdiameter bij torsie", en: "Shaft diameter under torsion" },
    standard: "τ = 16T/(πd³)",
    blurb: {
      nl: "Minimale asdiameter uit koppel en toelaatbare schuifspanning; controleer optioneel een gekozen diameter.",
      en: "Minimum shaft diameter from torque and allowable shear stress; optionally check a chosen diameter.",
    },
    tags: [
      "as",
      "torsie",
