    ...
    units: [
      {
        id: "mm2",
        symbol: "mm²",
        name: "vierkante millimeter",
        nameEn: "square millimeter",
        toBase: 1e-6,
        system: "si",
      },
      {
        id: "cm2",
        symbol: "cm²",
        name: "vierkante centimeter",
        nameEn: "square centimeter",
        toBase: 1e-4,
        system: "si",
      },
      {
        id: "dm2",
        symbol: "dm²",
        name: "vierkante decimeter",
        nameEn: "square decimeter",
        toBase: 1e-2,
        system: "si",
      },
      {
    ...
    units: [
      {
        id: "mm3",
        symbol: "mm³",
        name: "kubieke millimeter",
        nameEn: "cubic millimeter",
        toBase: 1e-9,
        system: "si",
      },
      {
        id: "cm3",
        symbol: "cm³",
        name: "kubieke centimeter",
        nameEn: "cubic centimeter",
        toBase: 1e-6,
        system: "si",
      },
      {
      ...
      },
      {
        id: "dm3",
        symbol: "dm³",
        name: "kubieke decimeter",
        nameEn: "cubic decimeter",
        toBase: 1e-3,
        system: "si",
      },
    ...
    units: [
      {
        id: "mms",
        symbol: "mm/s",
        name: "millimeter per seconde",
        nameEn: "millimeter per second",
        toBase: 1e-3,
        system: "si",
      },
      {
    ...
    units: [
      {
        id: "nmm",
        symbol: "N·mm",
        name: "newtonmillimeter",
        nameEn: "newton-millimeter",
        toBase: 1e-3,
        system: "si",
      },
      {
      ...
      },
      {
        id: "kgfm",
        symbol: "kgf·m",
        name: "kilogramkrachtmeter",
        nameEn: "kilogram-force meter",
        toBase: G0,
        system: "other",
      },
      {
  ...
  },
  {
    ...
    units: [
      ...
      { id: "kw", symbol: "kW", name: "kilowatt", nameEn: "kilowatt", toBase: 1e3, system: "si" },
      {
        id: "pk",
        symbol: "pk",
        name: "paardenkracht (metrisch)",
        nameEn: "metric horsepower",
        toBase: 735.49875,
        system: "other",
      },
      {
        id: "hp",
        symbol: "hp",
        name: "horsepower (mechanisch)",
        nameEn: "horsepower (mechanical)",
...
function sanitizePlain(v: string) {
  ...
  if (sep >= 0) {
    const mark = v[sep];
    const [head, tail = ""] = (v.slice(0, sep + 1) + v.slice(sep + 1).replace(/[.,]/g, "")).split(
      mark,
    );
