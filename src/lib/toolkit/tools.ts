...
export const TOOLS = [
  ...
  },
  {
    ...
    blurb: "Rollenbaan/band/helling/hijsen: n, F, T, P en volgende IEC-kW-stap.",
    blurbEn: "Roller conveyor/belt/incline/hoist: n, F, T, P and next IEC kW step.",
  ...
  },
  {
    ...
    blurb: "F = p·A, dubbelwerkend. ISO-boring bij last en 6 bar. Geen knik, geen Festo-type.",
    blurbEn: "F = p·A, double acting. ISO bore from load at 6 bar. No buckling, no Festo type.",
