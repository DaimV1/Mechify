...
const STANDARD_GROUPS = [
  {
    standard: "ISO 286",
    note: { nl: "Voorkeurpassingen en limietafwijkingen voor gaten en assen.", en: "Preferred fits and limit deviations for holes and shafts." },
  },
  {
    standard: "ISO 2768",
    note: { nl: "Algemene toleranties voor lineaire en hoekmaten.", en: "General tolerances for linear and angular dimensions." },
  },
  {
    standard: "DIN 6885",
    note: { nl: "Spiebaanmaten en toleranties voor as-naafverbindingen.", en: "Keyway dimensions and tolerances for shaft-hub connections." },
  },
  {
    standard: "SKF · ISO 286",
    note: { nl: "Lagerpassingen voor groefkogellagers.", en: "Bearing fits for deep groove ball bearings." },
  },
  {
  ...
  },
  {
    ...
    note: { nl: "Bevestigingsmateriaal: doorlaat en aandraaimoment.", en: "Fasteners: clearance holes and tightening torque." },
  },
  {
    standard: "ISO 3601-1",
    note: { nl: "O-ringgroeven voor statische en dynamische afdichting.", en: "O-ring grooves for static and dynamic sealing." },
  },
];
            ...
            return (
              <div key={group.standard} className="p-5 sm:p-6">
                <div className="flex flex-wrap items-center gap-3">
                  <h2 className="font-mono text-sm font-semibold uppercase tracking-wide text-accent">{group.standard}</h2>
                </div>
