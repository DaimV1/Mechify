  ...
  return (
    <>
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-2">
          ...
          <Field label={tx(locale, "Inbouw", "Installation")}>
            <SelectInput value={kind} onChange={(v) => setKind(v as OringKind)}>
              ...
              <option value="hydro">
                {tx(locale, "Hydrauliek, dynamisch", "Hydraulic, dynamic")}
              </option>
            </SelectInput>
          </Field>
        </div>
          ...
          <>
            ...
            <p className="mt-4 text-sm leading-relaxed text-muted">
              {tx(
                ...
                "Dichtomatik; not a substitute for ISO 3601-2.",
              )}
            </p>
      ...
      <section className="mt-12">
        ...
        <SchemaPanel caption={tx(locale, "Dwarsdoorsnede · ISO 3601", "Cross-section · ISO 3601")}>
