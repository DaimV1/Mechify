      ...
      <CalcPanel>
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-3">
          ...
          <Field label={tx(locale, "Sterkteklasse", "Strength class")}>
            <SelectInput value={klass} onChange={(v) => setKlass(v as Strength)}>
        ...
        {row && hole != null ? (
          <>
            ...
            <ResultGrid
              items={[
                ...
                fv != null
                  ? {
                      label: tx(locale, "Voorspanning Fv", "Preload Fv"),
                      value: `${fmtForce(fv)} N`,
                    }
          ...
          <p className="mt-5 text-sm text-muted">
            {tx(locale, "Kies een M-maat.", "Choose an M size.")}
          </p>
        )}
      </CalcPanel>
      ...
      <section className="mt-10">
        ...
        <p className="mt-4 text-xs leading-relaxed text-subtle">
          ...
          >
            {tx(
              locale,
              "Engineers Edge — ISO 4762 maattabel",
              "Engineers Edge — ISO 4762 size table",
            )}
          </a>
        </p>
      </section>
